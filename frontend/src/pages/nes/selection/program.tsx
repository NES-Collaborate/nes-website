...
import Table from "@/components/nes/selection/Table"
    ...
    <div className="min-height flex flex-col">
      ...
      <div className="flex-1">
        ...
        >
          ...
          <h1 className="w-11/12 text-primary text-2xl mb-4 text-center underline hover:text-secondary">
        ...
        {selection?.schedule && (
          ...
          >
            ...
            <div className="w-full flex flex-col items-center my-4">
              <h1 className="text-primary text-4xl stroke-1 mb-4">Cronograma</h1>
            </div>

            <ul className="list-disc list-inside w-5/6" key={selection.year}>
              {selection.schedule?.map((event, i) => (
                <li key={i} className="mb-1">
                  <span className="text-primary">{event.date}</span> - {event.description}
                </li>
              ))}
            </ul>
          </div>
        ...
        <a
          ...
          id="program"
        >
          <h1 className="text-primary text-4xl stroke-1 mb-4 text-center">
